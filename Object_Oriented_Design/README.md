...
Software design an architecture consists of four parts
...
Why I am taking this course? I am taking it because I want to design my project barber-shop properly.


#### Software Architect and Design Roles in industry

Both of them are forward-thinker and detailed oriented.

Software Design -> Turning the requirements of a client into working code that is stable and maintainable and can be evolved.


The Architect -> The architect starts with the core problem a client needs to solve.


The architect and designer are important to make  Softwares live longer.


NOTE: Architecture is very important because if we made it wrong, the project will fail.

important: simplicity is an important factor the architect a good app.
...
### Object Oriented Thinking and Object Oriented Modeling



When solving a problem, object oriented modeling involves the practice of representing key concepts through objects in your software. Depending on the problem, many concepts, event instances of people, places =, or things, becomes distinct objects in the software.



### Software requirements, Conceptual and technical design.


Example: Building a house:

- Eliciting requirement: Gathering what a client want. e.g: A client want a three bedroom apartment and two bathrooms.  


- You may want to ask follow p questions. For example,


1- Does the client need a kitchen?

2- How big are the rooms?

3- What is the overall size of the house?

4- Should a house face a particular direction?


These are the eliciting requirements.

We have a now an initial set of requirement after answering these questions.

Now you can think of a design for a system.

We need to make the conceptual design and technical design which produces


1- conceptual Mockup: provides the initial thoughts on how the requirement will be satisfied. Think of components and connections. Going back to the house example components will be the room, kitchen, bathroom and living room, Connections for example the kitchen is connected to the living room because it opens to the living room. Each component has a task that needs to perform known as responsibility.

2- Technical diagram: is breaking up the major components in the conceptual design to smaller and smaller components. Foe example, the gym. The gym floor has to handle a lot of weight because the home owner is trying to be an olympic lifter.


- Software Example for using concept and technical design.

Example: A university course search design.


Requirement: As a learner, I want to search for relevant courses through a search page.

Conceptual design: What are some potential components to be included in the CD?
